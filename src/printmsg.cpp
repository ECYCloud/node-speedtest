...
LOOKUP_ITEM SPEEDTEST_MESSAGES[] =
{
    ...
    {SPEEDTEST_MESSAGE_FOUNDVMESS, "检测到单条 V2Ray 链接。\n"},
    {SPEEDTEST_MESSAGE_FOUNDSS, "检测到单条 Shadowsocks 链接。\n"},
    {SPEEDTEST_MESSAGE_FOUNDSSR, "检测到单条 ShadowsocksR 链接。\n"},
    {SPEEDTEST_MESSAGE_FOUNDTROJAN, "检测到单条 Trojan 链接。\n"},
    {SPEEDTEST_MESSAGE_FOUNDVLESS, "检测到单条 VLESS 链接。\n"},
    {SPEEDTEST_MESSAGE_FOUNDHY2, "检测到单条 Hysteria2 链接。\n"},
    {SPEEDTEST_MESSAGE_FOUNDANYTLS, "检测到单条 AnyTLS 链接。\n"},
    {SPEEDTEST_MESSAGE_FOUNDSOCKS, "检测到单条 Socks 5 链接。\n"},
    {SPEEDTEST_MESSAGE_FOUNDNETCH, "检测到单条 Netch 链接。\n"},
    ...
    {SPEEDTEST_MESSAGE_STARTPING, "正在执行 TCP Ping 测试...\n"},
    {SPEEDTEST_MESSAGE_STARTGEOIP, "正在解析 GeoIP 信息...\n"},
    {SPEEDTEST_MESSAGE_STARTGPING, "正在执行 Google Ping 测试...\n"},
    {SPEEDTEST_MESSAGE_STARTSPEED, "正在执行下载速度测试...\n"},
    {SPEEDTEST_MESSAGE_STARTUPD, "正在执行上传速度测试...\n"},
    {SPEEDTEST_MESSAGE_GOTRESULT, "测试结果 - 平均速度：?0?  最大速度：?1?  上传速度：?2?  丢包率：?3?  平均延迟：?4?  Google 延迟：?5?  NAT 类型：?6?\n"},
