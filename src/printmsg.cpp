...
LOOKUP_ITEM SPEEDTEST_MESSAGES[] =
{
    ...
    {SPEEDTEST_MESSAGE_FOUNDVLESS, "Found single VLESS link.\n"},
    {SPEEDTEST_MESSAGE_FOUNDHY2, "Found single Hysteria2 link.\n"},
    {SPEEDTEST_MESSAGE_FOUNDANYTLS, "Found single AnyTLS link.\n"},
