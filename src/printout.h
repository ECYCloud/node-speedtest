...
enum
{
    ...
    SPEEDTEST_MESSAGE_FOUNDHY2,
    SPEEDTEST_MESSAGE_FOUNDANYTLS,
    SPEEDTEST_MESSAGE_FOUNDTUIC,
    SPEEDTEST_MESSAGE_FOUNDHYSTERIA,
    SPEEDTEST_MESSAGE_FOUNDWIREGUARD,
    SPEEDTEST_MESSAGE_FOUNDSSH,
    SPEEDTEST_MESSAGE_FOUNDMIERU,
    SPEEDTEST_MESSAGE_FOUNDSHADOWTLS,
...
#define SHADOWTLS_DEFAULT_GROUP "ShadowTLSProvider"
